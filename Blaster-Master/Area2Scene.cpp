...
void CArea2Scene::_ParseSection_TEXTURES(string line)
{
...
void CArea2Scene::_ParseSection_SPRITES(string line)
{
	vector<string> tokens = split(line);
...
void CArea2Scene::_ParseSection_ANIMATIONS(string line)
{
	vector<string> tokens = split(line);
...
void CArea2Scene::_ParseSection_ANIMATION_SETS(string line)
{
	vector<string> tokens = split(line);
...
void CArea2Scene::_ParseSection_OBJECTS(string line)
{
	...
	case OBJECT_TYPE_MARIO:
		...
		break;
	case OBJECT_TYPE_GOOMBA: obj = new CBrick(); break;
	case OBJECT_TYPE_BRICK: obj = new CBrick(); break;
	case OBJECT_TYPE_KOOPAS: obj = new CBrick(); break;
